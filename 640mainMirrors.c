...
/* On macOS, compile with...
 clang 640mainMirrors.c 000pixel.o -lglfw3 -framework OpenGL -framework Cocoa -framework IOKit
...
void colorScene(rayQuery query, double rgb[3]){
    ...
    if (result.intersected == rayNONE) {
        ...
        colorSphereMirror(&isomB, radiusB, colorB,
                &tex, query, result,
                    rgb);
    }
}
